    ...
    <>
      <div className="  is-flex is-justify-content-center  w-100">
          ...
          <div className="columns is-mobile box search-box ">
            <div className="column  is-9 is-paddingless">
              <div className="search-block" id="searchBlock">
                ...
                <input
                  className="search-input home-input is-family-monospace"
                  placeholder={
                    t("title") + ", " + t("author") + ", " + t("tags") + "..."
                  }
                  type="/search"
                  value={searchValue}
        ...
        <div className="search-box is-flex is-justify-content-center selected-types-search  mb-2">
          {selectedTypes
            ? selectedTypes.map((role) => {
                return (
                  <Fragment key={role.slug}>
                    <span className="tag is-primary mb-1 is-medium mr-1">
            ...
            : null}
          {value[0] !== oldest || value[1] !== newest ? (
            <span className="tag is-light has-text-primary mb-1 is-medium mr-1">
              {value[0]} - {value[1]}
            </span>
          ) : null}
        </div>
