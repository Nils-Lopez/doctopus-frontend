...
const VisitorsDash = ({}) => {
  ...
  const { getVisitorsChart, responseVisitorsChart } = useDashboard();
  ...
  useEffect(() => {
    ...
    if (
      ...
      responseVisitorsChart.success &&
      chartLoading &&
      responseVisitorsChart.type === chartTypes[chartType]
    ) {
      ...
      <div className="ml-2 pl-2">
        <div className="container is-flex is-justify-content-start mb-6">
          <div className="mr-4  mb--1">
            <div
              className="dropdown is-active visitordropdown"
