...
const DocumentsDash = ({}) => {
  ...
  useEffect(() => {
    if (
      historyLoading &&
      responseDocsHistory &&
      responseDocsHistory.success &&
      responseDocsHistory.data !== history
    ) {
          ...
          <div className="mr-4  mb--1">
            ...
            {chartType === 0 ? (
              <div
                ...
                <div className="dropdown-trigger">
                  <button className="button is-primary pt-1 pb-0 ml-2 has-text-monospace">
                    <span>{t(chartRanges[chartRange])}
                    &nbsp;
                    {chartRangeDropdown ? (
                      <FontAwesomeIcon icon={faChevronUp} />
                    ) : (
          ...
          <div className="mt--1">
            {historyRange[0] !== "0" ? (
              <button
                ...
                onClick={() => {
                  setHistoryRange(
                    historyRange.split("-")[0] * 1 -
                      15 +
                      "-" +
                      (historyRange.split("-")[1] * 1 - 15)
                  );
                  setHistory([]);
                }}>
                <FontAwesomeIcon
