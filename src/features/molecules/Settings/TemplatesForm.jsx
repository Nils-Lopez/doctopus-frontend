  ...
  const [copiesRank, setCopiesRank] = useState(true)
    ...
    useEffect(() => {
      if (responseCreateDocTemplate && responseCreateDocTemplate.success && loadingCreateDocTemplate) {
        setAlert({ type: "success", message: { en: t('template-created'), fr: t('template-created') } })
    ...
    return <>
      <div className="panel mb-6 template-form-panel">
        ...
        {docTemplates.map((template) => {
          ...
          if ((!parentTemplate || parentTemplate._id === template._id) && !template.schema_parent) {
            ...
            {displayChilds && displayChilds.schema_childs && displayChilds.schema_childs[0] && displayChilds === template && displayChilds.schema_childs.map((child) => {
              ...
              <div className="column is-four-fifth">
                <span className="panel-block">
                  <small className="has-text-grey"><i>{t('template')}: </i></small> &nbsp;{child.schema_name}   
                </span>
              </div>
              <div className="column is-one-quarter is-flex is-justify-content-end">
       ...
       {editTemplate ?  <div className="panel-block">
           <button className="button is-primary" onClick={handleNewTemplate}>{t('create-template')}</button>
        </div> : null}
      </div>
      <hr />
...
<label htmlFor="switchDesc" className="label">{t('description')}</label>
</div>
       </div>
       <div className="column is-flex is-justify-content-start">
        <div className="field">
...
<label htmlFor="switchCopyr" className="label">{t('copyrights')}</label>
</div>
       </div>
     </div> : null}
...
<label htmlFor="switchLang" className="label">{t('language')}</label>
</div>
       </div>
...
: null}
<label htmlFor="switchTags" className="label">{t('tags')}</label>
</div>
       </div>
       <div className="column">
<div className="field">
...
: null}
<label htmlFor="switchDocTypes" className="label">{t('types')}</label>
</div>
       </div>
       <div className="column">
<div className="field">
           {docTypeValue ? <>
             <RoleForm location={"templates"} scope="docs" selectedRoles={selectedDocTypes} selectRole={selectDocType} lang={idLang}/>
           </> : <>
           <input type="text" className="input" disabled/>
           </>}
         </div>
...
<div className="field">
           {typeValue ? <>
             <RoleForm location={"templates"} scope="docs" selectedRoles={selectedTypes} selectRole={selectType} lang={idLang}/>
           </> : <>
           <input type="text" className="input" disabled/>
           </>}
         </div>
...
:null}
           <label htmlFor="switchIssn" className="label">{t('issn')}</label>
         </div>
       </div>
     ...
     <div className="columns ml-6 mr-6">
       <div className="column is-half">
         <div className="field is-flex is-flex is-justify-content-space-between">
           ...
           <label htmlFor="switchDescSupp" className="label">{t('description')}</label>
         </div>
         <div className="field is-flex is-flex is-justify-content-start">
           ...
           <label htmlFor="switchDate" className="label">{t('sort-date')}</label>
         </div>
         <div className="field is-flex is-flex is-justify-content-start">
           ...
           <label htmlFor="switchDateTxt" className="label">{t('date-text')}</label>
         </div>
         <div className="field is-flex is-flex is-justify-content-start">
         ...
         <div className="field is-flex is-flex is-justify-content-start">
           ...
           <label htmlFor="switchEan" className="label">{t('ean-isbn')}</label>
         </div>
         <div className="field is-flex is-flex is-justify-content-start">
           ...
           <label htmlFor="switchVolume" className="label">{t('volume')}</label>
         </div>
         <div className="field is-flex is-flex is-justify-content-start">
           ...
           <label htmlFor="switchFormat" className="label">{t('format')}</label>
         </div>
       ...
       <div className="column is-half">
         <div className="field is-flex is-flex is-justify-content-start">
           ...
           <label htmlFor="switchPages" className="label">{t('pages')}</label>
         </div>
         <div className="field is-flex is-flex is-justify-content-start">
           ...
           <label htmlFor="switchDuration" className="label">{t('duration')}</label>
         </div>
         <div className="field is-flex is-flex is-justify-content-start">
           ...
           <label htmlFor="switchThumb" className="label">{t('thumbnail')}</label>
         </div>
         <div className="field is-flex is-flex is-justify-content-start">
           ...
           <label htmlFor="switchUrl" className="label">{t('link-url')}</label>
         </div>
         <div className="field is-flex is-flex is-justify-content-start">
           ...
           <label htmlFor="switchAccess" className="label">{t('accessibility')}</label>
         </div>
         <div className="field is-flex is-flex is-justify-content-start">
           ...
           <label htmlFor="switchNumber" className="label">{t('number')}</label>
         </div>
       </div>
     ...
     <div className="columns mr-6 ml-6">
         <div className="column is-half">
           <div className="field is-flex is-flex is-justify-content-space-between">
             ...
             <label htmlFor="switchCopies" className="label">{t('copies')}</label>
           </div>
           <div className="field is-flex is-flex is-justify-content-space-between">
             ...
             <label htmlFor="switchRank" className="label">{t('rank')}</label>
         </div>
         <div className="field is-flex is-flex is-justify-content-space-between">
             ...
             <label htmlFor="switchQUal" className="label">{t('quality')}</label>
           </div>
         </div>
         <div className="column is-half">
           <div className="field is-flex is-flex is-justify-content-start">
             ...
             <label htmlFor="switchPosition" className="label">{t('position')}</label>
           </div>
           <div className="field is-flex is-flex is-justify-content-start">
             ...
             <label htmlFor="switchLoc" className="label">{t('location')}</label>
           </div>
         </div>
       </div>
     <hr />
...
: null}
<label htmlFor="switchParentOrg" className="label">{t('organization')}</label>
</div>
       </div>
       <div className="column">
         <div className="field">
           {orgValue ? <>
             <OrganisationParentForm location={"templates-parents"} selectedOrg={selectedOrg} selectOrg={selectOrg}  lang={idLang} hideRoles={!parentRolesValue} client={client} setAlert={setAlert} />
           </> : <>
             <input type="text" className="input" disabled/>
           </>}
         </div>
...
: null}
<label htmlFor="switchParentProj" className="label">{t('projects')}</label>
</div>
       </div>
       <div className="column">
<div className="field">
           {projValue ? <>
             <ProjectParentForm location={"templates-parents"} selectedProj={selectedProj} selectProj={selectProj} lang={idLang} hideRoles={!parentRolesValue} client={client} setAlert={setAlert}/>
           </> : <>
           <input type="text" className="input" disabled/>
           </>}
         </div>
