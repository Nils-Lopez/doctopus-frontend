...
import { faC, faCheckCircle, faCirclePlus, faCircleXmark, faPencil, faTrash, faXmarkCircle } from "@fortawesome/free-solid-svg-icons"
...
const ApplicationDash = ({applicationSettings, setApplicationSettings}) => {
    ...
    const handleUpdateAppSettings = (e) => {
        ...
        const newSettings = {
            ...
            global: {
                ...
                tagline: [{lang: 'en', content: taglineEnValue}, {lang: 'fr', content: taglineFrValue}],
                fontSerif: fontSerifValue !== "" ? fontSerifValue.value : false,
                fontSansSerif: fontSansSerifValue !== "" ? fontSansSerifValue.value : false,
                logo: logoValue,
    ...
    useEffect(() => {
        ...
        setBackgroundType({value: applicationSettings.backgroundType, label: applicationSettings.backgroundType})
        setHomePageDocsTypes({value: applicationSettings.homePageDocsTypes, label: applicationSettings.homePageDocsTypes})
        setFaviconValue(applicationSettings.global.favicon)
        setLogoValue(applicationSettings.global.logo)
        setFontSerifValue({value: applicationSettings.global.fontSerif, label: applicationSettings.global.fontSerif})
        setFontSansSerifValue({value: applicationSettings.global.fontSansSerif, label: applicationSettings.global.fontSansSerif})
    ...
    if (staticPageComponents.length > 0) {
        staticPageComponents.map((c, i) => componentPositions.push({
            value: (i+1).toString(),
            label: (i+1).toString()
        }))
    ...
    return <div className="">
            ...
            <div className="columns">
                <div className="column">
                    <div className="control">
                        <input type="text" className="input" placeholder="fr"  value={titleFrValue} onChange={e => {
                                e.preventDefault()
                ...
                <div className="column">
                    <div className="control">
                        <input type="text" className="input"  placeholder="en"  value={titleEnValue} onChange={e => {
                                e.preventDefault()
        ...
        <div className="field">
            ...
            <div className="columns">
                <div className="column">
                    <div className="control">
                        <input type="text" className="input" placeholder="fr"  value={taglineFrValue} onChange={e => {
                                e.preventDefault()
                ...
                <div className="column">
                    <div className="control">
                        <input type="text" className="input"  placeholder="en"  value={taglineEnValue} onChange={e => {
                                e.preventDefault()
        ...
        <div className="field">
            ...
            <div className="columns">
                <div className="column">
                    ...
                    <div className="control">
                        <input type="text" className="input" value={htmlTitleValue} onChange={e => {
                                e.preventDefault()
                ...
                <div className="column">
                    ...
                    <div className="control">
                        <input type="text" className="input"   value={htmlMetaTagValue} onChange={e => {
                                e.preventDefault()
        ...
        <div className="columns">
                <div className="column">
                    <div className="field">
                        ...
                        <div className="control has-icons-left">
                            <span className="icon is-left" style={{color: primaryColorValue}}>
                                <FontAwesomeIcon icon={faPencil}/>
                            </span>
                            <input type="text" className="input" value={primaryColorValue} onChange={e => {
                                e.preventDefault()
                ...
                <div className="column">
                    <div className="field">
                        ...
                        <div className="control has-icons-left">
                            <span className="icon is-left" style={{color: secondaryColorValue}}>
                                <FontAwesomeIcon icon={faPencil}/>
                            </span>
                            <input type="text" className="input" value={secondaryColorValue} onChange={e => {
                                e.preventDefault()
        ...
        <div className="columns">
            <div className="column">
                <div className="field">
                    ...
                    <SelectForm selected={fontSerifValue} select={setFontSerifValue} options={serifFonts} applicationSettings={applicationSettings}/>
                </div>
            </div>
            <div className="column">
                <div className="field">
                    ...
                    <SelectForm selected={fontSansSerifValue} select={setFontSansSerifValue} options={sansSerifFonts} applicationSettings={applicationSettings}/>
        ...
        <div className="columns">
            <div className="column">
                <div className="field">
                    ...
                    <SelectForm select={setBackgroundType} selected={backgroundType} options={backgroundTypes} applicationSettings={applicationSettings}/>
                </div>
            </div>
            {backgroundType && backgroundType.value === "Color" ? <div className="column">
                <div className="field">
                        <label className="label has-text-left">
                            Background color
                        </label>
                        ...
                        <div className="control has-icons-left">
                            <span className="icon is-left" style={{color: backgroundColor}}>
                                <FontAwesomeIcon icon={faPencil}/>
                            </span>
                            <input type="text" className="input" value={backgroundColor} onChange={e => {
                                e.preventDefault()
        ...
        {backgroundType && backgroundType.value === "Document's pictures" ? <div className="field">
            <label className="label has-text-left mb--1">
                Background documents
            </label>
            <DocParentForm selectedDoc={backgroundDocs} selectDoc={setBackgroundDocs} hideRoles={true} location={"app-dash"}/>
        </div> : backgroundType && backgroundType.value === "Picture" ? <>
            <div className="field">
                <label className="label has-text-left">
                    Picture Url
                </label>
               
                <input type="text" className="input" value={pictureUrl} onChange={e => {
                    e.preventDefault()
        ...
        <div className="field mt-4 pt-3">
            ...
            <SelectForm select={setHomePageDocsTypes} selected={homePageDocsTypes} options={homepageDocTypes} applicationSettings={applicationSettings}/>
        </div>
        {homepageDocTypes && homePageDocsTypes.value === "Selected" ? <>
            <div className="field">
                ...
                <DocParentForm selectedDoc={homePageDocs} selectDoc={setHomePageDocs} hideRoles={true} location={"app-dash"}/>
            </div>
        </> : null}
        <div className="field mt-4 pt-3">
            <label className="label has-text-left">
            ...
            {homePageSubtitles?.map((sub, i) => <>
                <Fragment key={sub}>
                    <div className="is-flex is-justify-content-start ">  
                        ...
                        <span className="tag is-medium has-text-danger pointer ml-3" onClick={() => {
                            setHomePageSubtitles(homePageSubtitles.filter((s) => {
                                if (s !== sub) return s
                            }))
                        }}>
            ...
            <div className="columns">
                <div className="column is-5">
                    <div className="control">
                        <input type="text" className="input" placeholder="fr"  value={subtitleFrValue} onChange={e => {
                                e.preventDefault()
                ...
                <div className="column is-5">
                    <div className="control">
                        <input type="text" className="input" placeholder="fr"  value={subtitleEnValue} onChange={e => {
                                e.preventDefault()
                ...
                <div className="column is-1">
                    <h1 className="title is-4 has-text-primary pt-2 mr-2 pointer" onClick={() => {
                        setHomePageSubtitles([...homePageSubtitles, {subtitle: [{lang: "en", content: subtitleEnValue}, {lang: "fr", content: subtitleFrValue}]}])
                        setSubtitleEnValue('')
                        setSubtitleFrValue('')
                    }}>
        ...
        {staticPages?.map((page) => {
            return <Fragment key={JSON.stringify(page)}>
                <div className="tag is-large">
                    ...
                    <span className="has-text-info pointer ml-3" onClick={() => {
                        ...
                        setStaticPages([...staticPages].filter((p) => {
                            if (p !== page) return p
                        }))
                    }}>
                        <FontAwesomeIcon icon={faPencil}/>
                    </span>
                    <span className="has-text-danger pointer ml-3" onClick={() => {
                        setStaticPages([...staticPages].filter((p) => {
                            if (p !== page) return p
                        }))
                    }}>
        ...
        <div className="field">
            ...
            <div className="columns">
                <div className="column">
                    <div className="control">
                        <input type="text" className="input" placeholder="fr"  value={pageTitleFrValue} onChange={e => {
                                e.preventDefault()
                ...
                <div className="column">
                    <div className="control">
                        <input type="text" className="input"  placeholder="en"  value={pageTitleEnValue} onChange={e => {
                                e.preventDefault()
        ...
        <div className="is-flex is-justify-content-space-between mb-3 columns is-multiline">
            {staticPageComponents.map((component) => {
                return <Fragment key={component}>
                    <div className="tag is-large mt-1 mb-1">
                        {component.type}
                        <span className="has-text-info pointer ml-3 " onClick={() => {
                            setComponentContentEnValue(getContent(component.content, "en"))
                            setComponentContentFrValue(getContent(component.content, "fr"))
                            setComponentType({value: component.type, label: component.type})
                            
                            setStaticPageComponents([...staticPageComponents].filter((c) => {
        ...
        <div className="columns">
            <div className="column">
                <div className="field">
                    ...
                    <SelectForm options={componentTypes} select={setComponentType} selected={componentType}/>
                </div>
            </div>
        ...
        <div className="field">
            ...
            <div className="columns">
                <div className="column">
                    <div className="control">
                        <input type="text" className="input" placeholder="fr"  value={componentContentFrValue} onChange={e => {
                                e.preventDefault()
                ...
                <div className="column">
                    <div className="control">
                        <input type="text" className="input"  placeholder="en"  value={componentContentEnValue} onChange={e => {
                                e.preventDefault()
        ...
        <div className="is-flex is-justify-content-end">
            <button className="button is-primary tag is-medium mt-3" onClick={() => {
                setStaticPageComponents([...staticPageComponents, {
        ...
        <div className="is-flex is-justify-content-center mt-3">
                <button className="button tag is-large is-primary" onClick={handleUpdateAppSettings}>
