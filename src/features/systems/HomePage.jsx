...
const HomePage = ({client, setAlert}) => {
  ...
  useEffect(() => {
    if (responseSearch && responseSearch.success && responseSearch.data && responseSearch.data[0]) {
  ...
  return <>
    <div>
      ...
      <div className="landing-content">
          {empty ? <>No match for your query, try something else ...</> : <>
            {loadingSearch ? "loading..." : !result[0] ? <Landing/> : <SearchResult result={result} client={client} setAlert={setAlert} page={page}/>}
          </>}
          {!loadingSearch && result.length > 20 ? <div className="is-flex is-justify-content-end mr-6">
