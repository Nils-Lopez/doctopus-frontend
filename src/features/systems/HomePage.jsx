...
const HomePage = ({client, setAlert}) => {
  ...
  return <>
    <div>
      ...
      <svg className="background-landing-ctn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#EE6636" fillOpacity="0.9" d="M0,256L48,240C96,224,192,192,288,197.3C384,203,480,245,576,240C672,235,768,181,864,176C960,171,1056,213,1152,218.7C1248,224,1344,192,1392,176L1440,160L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>
