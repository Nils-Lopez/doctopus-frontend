...
function App() {
  ...
  useEffect(() => {
    if (applicationSettings && applicationSettings.global && applicationSettings.global.title[0]) {
      ...
      if (settings.fontSerif) root?.style.setProperty("--serif", settings.fontSerif);
      if (settings.fontSansSerif) root?.style.setProperty("--sans-serif", settings.fontSansSerif);
      ...
      if (settings.metaTagValue) document.querySelector('meta[name="description"]').setAttribute("content", settings.metaTagValue);
      if (settings.htmlTitle) document.title = settings.htmlTitle
      if (applicationSettings.backgroundColor && applicationSettings.backgroundColor !== "") root?.style.setProperty("--bg-color", applicationSettings.backgroundColor);
  ...
  return (
    <div className="App">
      {applicationSettings ? <Router applicationSettings={applicationSettings} setApplicationSettings={setApplicationSettings}/> :
